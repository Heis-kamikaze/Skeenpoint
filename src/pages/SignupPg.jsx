...
const SignupPg = () => {
  ...
  return (
    <div className="pb-32 pt-24 md:pt-32 bg-gradient-to-b from-neutral-300 to-stone-400">
          ...
          <div>
            ...
            <div className="mt-1 relative rounded-md shadow-sm">
              ...
              <input
                ...
                autoComplete="name"
                required
                className="focus:ring-rust-100 h-10 w-full focus:border-b1-100 block pl-10 sm:text-sm border-gray-300 rounded-md placeholder-b1-100"
      ...
      <div>
        <p className="mt-2 text-center text-sm text-gray-600">
          ...
          <Link to="/login" className="font-medium text-rust-100 hover:text-rust-200">
            Log in
          </Link>
        </p>
      </div>
