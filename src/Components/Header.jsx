  ...
  return (
    <div className="fixed z-50 w-full">
      <div className="flex justify-between items-center bg-white pr-1">
        <div>
          <Link to="/">
            <img src="https://res.cloudinary.com/dk60nznrm/image/upload/v1726052557/logo_w3xjkz.png" alt=" logo" className="w-12 md:w-24" />
          </Link>
        </div>
        <p>
          {user && user.name}
        ...
        <div className="flex gap-1">
          {user ? (
            ...
            <div className="flex justify-center items-center pb-1">
                <button className="border border-rust-100 text-rust-100 text-xs md:text-xl text-center font-light px-2 py-1 rounded-md md:rounded-lg mt-2 w-fit md:mr-4 mr-2" 
                  onClick={navSign}
                >
                  SignUp
                </button>
      ...
      <div className="sm:hidden">
        <ul
          className={`justify-evenly bg-white w-full flex md:static sm:hidden py-5 ${
